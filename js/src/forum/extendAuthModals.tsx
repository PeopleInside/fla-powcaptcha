...
function applyToModal(modulePath: string, enabledKey: string, dataMethod: string): void {
    ...
    extend(modulePath, 'onerror', function (this: any) {
        if (!isEnabled(enabledKey)) return;
